...
public class LiveActivity_LandScape extends AppCompatActivity {
    private static final String TAG = LiveActivity_LandScape.class.getSimpleName();
    ...
    RESConnectionListener resConnectionListener = new RESConnectionListener() {
        ...
        public void onOpenConnectionResult(int result) {
            //result 0成功  1 失败
            Toast.makeText(LiveActivity_LandScape.this,"打开推流连接 状态："+result+ " 推流地址："+rtmpUrl,Toast.LENGTH_LONG).show();
        }

        @Override
        public void onWriteError(int errno) {
            Toast.makeText(LiveActivity_LandScape.this,"推流出错,请尝试重连",Toast.LENGTH_LONG).show();
        }

        @Override
        public void onCloseConnectionResult(int result) {
            //result 0成功  1 失败
            Toast.makeText(LiveActivity_LandScape.this,"关闭推流连接 状态："+result,Toast.LENGTH_LONG).show();
        }
    };
