...
package com.example.p013_updatemanager.download.handlerthread;
...
public class DownloadHandlerThread extends HandlerThread implements Handler.Callback {
    ...
    public DownloadHandlerThread(final String name) {
        super(name);
    }
    ...
    public DownloadHandlerThread setUIHandler(final Handler UIHandler) {
