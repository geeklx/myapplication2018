package com.example.p009_flowlayout;
...
import com.example.p009_flowlayout.common.CommonUserFragment;
...
public class CategoryActivity extends AppCompatActivity {
    ...
    private String[] mTabTitles = new String[]
            {"Muli Selected", "Limit 3",
                    "Event Test", "ScrollView Test", "Single Choose", "Gravity", "ListView Sample", "CommonUser"};
