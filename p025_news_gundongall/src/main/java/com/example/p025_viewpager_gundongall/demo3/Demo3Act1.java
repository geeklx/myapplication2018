...
//import com.example.p025_viewpager_gundongall.utils.StatusBarUtils;
...
//
//public class Demo3Act1 extends AppCompatActivity {
//
//
...
////            StatusBarUtils.setXiaomiDarkMode(this);
////        } else if (brand.contains("Meizu")) {
////            StatusBarUtils.setMeizuDarkMode(this);
...
//                }
//
//                Glide.with(Demo3Act1.this).load(dataList.get(position).getCoverImageUrl()).into(viewHolder.imageView);
//            }
//
//            @Override
