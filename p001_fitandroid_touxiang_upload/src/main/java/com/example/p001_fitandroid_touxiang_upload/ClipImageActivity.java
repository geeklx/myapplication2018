...
import com.example.p001_fitandroid_touxiang_upload.view.ClipViewLayout;
...
//        getFileUtil.file_img_name = "geek_img" + type + GetFileUtil.file_name_geshi;
        getFileUtil.file_img = new File(GetFileUtil.file_img_url, "geek_img" + type + GetFileUtil.file_name_geshi);
        Uri mSaveUri = Uri.fromFile(getFileUtil.file_img);
        if (mSaveUri != null) {
