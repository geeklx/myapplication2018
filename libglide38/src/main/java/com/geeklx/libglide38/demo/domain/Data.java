package com.geeklx.libglide38.demo.domain;
...
public class Data {
    ...
    public static List<Data> get() {
        ...
        Data data0 = new Data();
        data0.avatar = "http://b162.photo.store.qq.com/psb?/V14EhGon4cZvmh/z2WukT5EhNE76WtOcbqPIgwM2Wxz4Tb7Nub.rDpsDgo!/b/dOaanmAaKQAA";
        data0.nickname = "萌新-lpe";
        data0.createTime = "昨天 11:21";
        data0.content = "开司还是那么帅";
        data0.pictureList = Arrays.asList(
        ...
        data0.pictureThumbList = Arrays.asList(
        ...
        Data data1 = new Data();
        data1.avatar = "http://b167.photo.store.qq.com/psb?/V14EhGon2OmAUI/hQN450lNoDPF.dO82PVKEdFw0Qj5qyGeyN9fByKgWd0!/m/dJWKmWNZEwAAnull";
        data1.nickname = "苦涩";
        data1.createTime = "昨天 09:59";
        data1.content = "唐僧还是厉害啊。为什么？有宝马";
        ...
        Data data2 = new Data();
        data2.avatar = "http://qlogo3.store.qq.com/qzone/383559698/383559698/100?1416542262";
        data2.nickname = "越线龙马";
        data2.createTime = "前天 14:61";
        data2.content = "雪.触之即化..愿永久飘零";
        ...
        data3.createTime = "昨天 06:00";
        data3.content = "人与人间的信任，就像是纸片，一旦破损，就不会再回到原来的样子。";
        ...
        Data data5 = new Data();
        data5.avatar = "http://b167.photo.store.qq.com/psb?/V14EhGon2OmAUI/hQN450lNoDPF.dO82PVKEdFw0Qj5qyGeyN9fByKgWd0!/m/dJWKmWNZEwAAnull";
        data5.nickname = "geek5";
        data5.createTime = "昨天 08:12";
        data5.content = "各种眼神";
